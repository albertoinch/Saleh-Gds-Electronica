...
const contribuyenteVal = require('./contribuyente-val');
...
module.exports = (app) => {
    ...
    * 
    */
    app.api.post('/contribuyente', validate({body: contribuyenteVal.post}), asyncHandler(app.controllers.contribuyente.post));
     ...
     * }
     */
    app.api.put('/contribuyente/:id', validate({body: contribuyenteVal.post}), asyncHandler(app.controllers.contribuyente.put));

    /**
    * @api {get} /api/v1/contribuyente/:page Recupera todas las sucursales
    * @apiGroup Venta
    ...
    *
    */
  app.api.get('/contribuyente/:page', asyncHandler(app.controllers.contribuyente.index));
  /**
    * @api {get} /api/v1/contribuyentes Recupera contribuyentes
    * @apiGroup Venta
    * @apiDescription Recupera datos de los contribuyentes
    * 
    * @apiHeader {String} Authorization Token de acceso generado para facturación
    ...
    *
    */
   app.api.get('/contribuyentes', asyncHandler(app.controllers.contribuyente.get));
};